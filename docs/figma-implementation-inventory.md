...
| Playback | paused on initial historical window | focus ring | play/pause, speed and seek update one clock | controls disabled while data loads |
...
- Historical clock: UTC session 2019-12-01; every market module resolves from that clock for play, pause, speed and seek.
